...
Original file is located at
    https://colab.research.google.com/drive/12MJ8dXsVcbV0NheQlnwhr-S1iSzvMaGz
"""
...
sample_function_code = """def add_numbers(a: int, b: int = 5) -> int:
    if a > 0 and b > 0:
        result = a + b
    else:
        result = 0
...
docstringed_function, status = generate_docstring(sample_function_code, style="google")
print(status)
print(docstringed_function)